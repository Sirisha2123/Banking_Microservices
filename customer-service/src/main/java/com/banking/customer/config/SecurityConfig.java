...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        System.out.println("Configuring Customer Service SecurityWebFilterChain - disabling CSRF");
        http
            .csrf(ServerHttpSecurity.CsrfSpec::disable) // Explicitly disable CSRF
            .authorizeExchange(exchanges -> exchanges
                .anyExchange().permitAll() // Temporarily permit all for testing (align with gateway)
            )
